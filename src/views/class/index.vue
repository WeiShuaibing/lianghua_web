    ...
    <div class="app-container">
      ...
      <el-dialog title="课程" :visible.sync="showCourseVisible">
        <el-table :data="coursesOfClass">
          <el-table-column property="courseId" label="ID" width="200"></el-table-column>
          <el-table-column property="name" label="课程名称" ></el-table-column>
          <el-table-column property="score" label="学分" width="200"></el-table-column>
        </el-table>
      </el-dialog>
        ...
        <el-dialog title="新增班级" :visible.sync="addVisible">
          <div style="width: 80%;margin: 0 auto;">
            <el-row>
              ...
              <el-col :span="18"><el-input placeholder="请输入..." v-model="myclass.name"></el-input></el-col>
            </el-row>
              ...
              <el-col :span="18">
                <el-select v-model="myclass.term" placeholder="请选择">
                  <template v-for="item in 20">
                    <el-option  :key="item" :label="item | termFilter1" :value="item | termFilter1"></el-option>
                    <el-option  :key="item * 100" :label="item | termFilter2" :value="item | termFilter2"></el-option>
                  </template>
                </el-select>
              </el-col>
            </el-row>
            <el-row style="margin-top: 20px;">
              ...
              <el-col :span="18">
                <el-select style="width: 600px;"  v-model="myclass.week" multiple placeholder="请选择">
                  <el-option v-for="item in 20" :key="item" :label="item | weekFilter" :value="item | weekFilter"></el-option>
                </el-select>
              </el-col>
            </el-row>
            <el-row style="margin-top: 20px;">
              <el-col :span="4"> <span style="line-height: 2">备注：</span></el-col>
              <el-col :span="18"><el-input placeholder="请输入..." v-model="myclass.remark"></el-input></el-col>
            </el-row>
            <el-row style="margin-top: 20px;">
              <el-col :span="4"> <span style="line-height: 2">课程：</span></el-col>
              <el-col :span="18">
                <el-select style="width: 600px;" v-model="myclass.course" multiple placeholder="请选择">
                  <el-option v-for="item in allCourse" :key="item.courseId" :label="item.name" :value="item.courseId"></el-option>
                </el-select>
              </el-col>
            </el-row>
          </div>
          <div style="margin-top: 60px;" slot="footer" class="dialog-footer">
...
import { save, getPage, update } from '../../api/class'
